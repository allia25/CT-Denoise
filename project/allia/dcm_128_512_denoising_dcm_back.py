...
if __name__ == "__main__":
    ...
    for i, low_name in enumerate(low_dcm_files):
        ...
        input = read_dcm_img(input_path)  # 使用read_dcm_img函数读取DCM图像
        ...
        if cond_folder is not None:
            ...
            if os.path.exists(cond_path):
                ...
                cond = read_dcm_img(cond_path)  # 使用read_dcm_img函数读取DCM图像
        ...
        if target_folder is not None:
            ...
            if os.path.exists(target_path):
                ...
                target = read_dcm_img(target_path)  # 使用read_dcm_img函数读取DCM图像
